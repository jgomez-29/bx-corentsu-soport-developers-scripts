...
- En README de un caso de uso: incluir descripción breve, cómo ejecutar (`python send_message.py` o desde raíz con ruta al script), archivos de entidades (`dev/entities/`, `qa/entities/`) y, si aplica, modos (archivo, stress test, etc.).
